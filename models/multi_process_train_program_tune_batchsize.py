...
def main_func(snp_num, data_dir, train_file_num, batch_size):
    """
    数据预处理
    """
...
if __name__ == '__main__':
    ...
    main_func(snp_num=snp_num, data_dir=data_dir, train_file_num=train_file_num, batch_size=batch_sizes)
